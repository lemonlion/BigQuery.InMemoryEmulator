...
namespace InMemoryEmulator.BigQuery.Tests.Unit.Phase15;
...
{
	private static InMemoryEmulator.BigQuery.SqlEngine.ProceduralExecutor CreateExecutor()
	{
		...
		return new InMemoryEmulator.BigQuery.SqlEngine.ProceduralExecutor(store, "test_ds");
	}
