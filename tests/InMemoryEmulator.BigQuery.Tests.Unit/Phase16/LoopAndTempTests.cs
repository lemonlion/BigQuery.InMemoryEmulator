...
namespace InMemoryEmulator.BigQuery.Tests.Unit.Phase16;
...
{
	private static (InMemoryEmulator.BigQuery.SqlEngine.ProceduralExecutor Executor, InMemoryDataStore Store) CreateExecutor()
	{
		...
		return (new InMemoryEmulator.BigQuery.SqlEngine.ProceduralExecutor(store, "test_ds"), store);
	}
	...
	{
		var stmts = InMemoryEmulator.BigQuery.SqlEngine.ProceduralExecutor.SplitStatements(
